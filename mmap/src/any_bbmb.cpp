...
// DONE: radu
AobbSearchNode* AnyBBMB::initSearchSpace() {
...
// DONE: radu
double AnyBBMB::heuristicOR(AobbSearchNode* n) {
...
// DONE: radu
bool AnyBBMB::doProcess(AobbSearchNode* node) {
	assert(node);
...
// DONE: radu
void AnyBBMB::addCacheContext(AobbSearchNode* node, const set<int>& ctxt) const {
...
// DONE: radu
bool AnyBBMB::doCaching(AobbSearchNode* node) {
...
// DONE: radu
bool AnyBBMB::doPruning(AobbSearchNode* node) {
...
// DONE: radu
AobbSearchNode* AnyBBMB::nextLeaf() {
...
bool AnyBBMB::canBePruned(AobbSearchNode* n) {
...
// DONE: radu
bool AnyBBMB::generateChildrenAND(AobbSearchNode* n, vector<AobbSearchNode*>& chi) {
...
// DONE: radu
bool AnyBBMB::generateChildrenOR(AobbSearchNode* n, vector<AobbSearchNode*>& chi) {
...
// DONE: radu
AobbSearchNode* AnyBBMB::nextNode() {
...
// DONE: radu
bool AnyBBMB::doExpand(AobbSearchNode* n) {
	assert(n);
	m_expand.clear();
