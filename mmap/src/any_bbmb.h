...
#ifndef SRC_ANY_BBMB_H_
#define SRC_ANY_BBMB_H_
 ...
 * by weighted mini-bucket heuristics.
 */

class AnyBBMB : public Search {
protected:
...
inline AnyBBMB::AnyBBMB(ProgramOptions* opt) : Search(opt) {
...
inline AnyBBMB::~AnyBBMB() {

}

inline bool AnyBBMB::isDone() const {
	return ( m_stack.empty() );
}


#endif /* SRC_ANY_BBMB_H_ */
