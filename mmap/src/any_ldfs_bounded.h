...
#ifndef SRC_ANY_LDFS_BOUNDED_H_
#define SRC_ANY_LDFS_BOUNDED_H_
...
class AnyLDFS_Bounded : public AOBF2 {
...
public:
	...
	AnyLDFS_Bounded(ProgramOptions* opt);
	~AnyLDFS_Bounded();

};

inline AnyLDFS_Bounded::AnyLDFS_Bounded(ProgramOptions* opt) : AOBF2(opt) {

}

inline AnyLDFS_Bounded::~AnyLDFS_Bounded() {
