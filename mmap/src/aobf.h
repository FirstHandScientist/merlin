...
#ifndef IBM_MAP_AOBF_H_
#define IBM_MAP_AOBF_H_
...
/* Standard Best-First AND/OR Search solver (AOBF) */

class AOBF : public Search {

protected:

	// The context-minimal AND/OR graph
	scoped_ptr<AobfSearchSpace> m_space;
...
protected:
	...
	std::string context(int var, int val, const std::set<int>& C);
...
inline AOBF::AOBF(ProgramOptions* o) : Search(o) {
