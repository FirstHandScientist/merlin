...
#ifndef MINI_BUCKET_JGLP_HEUR_H_
#define MINI_BUCKET_JGLP_HEUR_H_
...
class MiniBucketJglpHeur : public Heuristic {
public:
...
public:
	MiniBucketJglpHeur(Problem* p, Pseudotree* pt, ProgramOptions* po, int ib);
	~MiniBucketJglpHeur() {
	}
...
inline bool MiniBucketJglpHeur::isAccurate() {
	assert(m_pseudotree);
